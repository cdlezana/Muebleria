Public NotInheritable Class presentacion
    ...
    Private Sub SplashScreen1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If My.Application.Info.Title <> "" Then
            ApplicationTitle.Text = My.Application.Info.Title   '"Sistema Muebleria S.R.L" 
        Else
    ...
    Private Sub tiempo_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tiempo.Tick
        barra_pres.Increment(5)
        If barra_pres.Value = 20 Then
            tiempo.Stop()
            Login.Show()
            Me.Hide()
    ...
    Private Sub barra_pres_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles barra_pres.Click
